  ...
  return (
    <div className="min-h-screen bg-white p-4 md:p-8 lg:p-12 pb-24 md:pb-12">
      <div className="md:max-w-full md:mx-auto">
        ...
        <div className="mb-8 md:mb-12 bg-linear-to-r from-blue-50 to-purple-50 rounded-2xl shadow-sm p-5 md:p-8 border border-blue-100">
          <div className="flex items-center gap-4">
            <div className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-linear-to-br from-blue-500 to-purple-600 shadow-lg">
